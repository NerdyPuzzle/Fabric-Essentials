if (${input$entity} instanceof Player) {
	...
	PlayerInventoryStorage.of(entityPlayer${customBlockIndex}).getSlot(${input$slot}).insert(variantof${customBlockIndex}, ${input$amount}, transaction${customBlockIndex});
